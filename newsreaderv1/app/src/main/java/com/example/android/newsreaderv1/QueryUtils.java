...
/**
 * Helper methods related to requesting and receiving news article information from the Guardian.
 */
public final class QueryUtils {
    ...
    /**
     * Query the Guardian dataset and return a list of {@link News} article objects.
     */
