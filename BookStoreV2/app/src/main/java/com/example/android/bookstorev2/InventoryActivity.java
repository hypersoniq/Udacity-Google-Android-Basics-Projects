...
public class InventoryActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                // For example, the URI would be "content://com.example.android.bookstorev2/books/2"
    ...
    private void insertBook() {
        ...
        // Insert a new row for a book into the provider using the ContentResolver.
    ...
    private void deleteAllBooks() {
        ...
        Log.v("InventoryActivity", rowsDeleted + " rows deleted from books database");
    }
